...
// Connects to data-controller="jpg-to-pdf"
  ...
  sendrequest() {
    ...
    fetch('/convert_jpg_to_pdf', {
      ...
      .then(converted => {
        ...
        link.href = url;
        link.download = 'converted_images.pdf'; // Name of the downloaded file
        document.body.appendChild(link);
        link.click();
        link.remove();
        window.location.href = '/jpg_pdf'; // Redirect to the jpg page
      })
      .catch(error => {
