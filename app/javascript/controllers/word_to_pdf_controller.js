...
// Connects to data-controller="word-to-pdf"
  ...
  sendrequest() {
    ...
    fetch('/convert_word_to_pdf', {
      ...
      .then(converted => {
        ...
        link.href = url;
        link.download = 'converted_word.pdf'; // Name of the downloaded file
        document.body.appendChild(link);
        link.click();
        link.remove();
        window.location.href = '/word_pdf'; // Redirect to the jpg page
      })
      .catch(error => {
