...
// Connects to data-controller="pdf-lock"
export default class extends Controller {
  static targets = ["pdfsecuritypassword", "fileInput", "selectButton", "buttonContainer", "uploadContainer", "pdfmergeContainer", "previewContainer"]
  ...
  next() {
    ...
    document.getElementById("pdfsecuritypassword").classList.remove("hidden");
    this.filepreview();
  }
