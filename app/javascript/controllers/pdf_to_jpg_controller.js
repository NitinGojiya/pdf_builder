...
// Connects to data-controller="pdf-to-jpg"
...
sendrequest() {
  ...
  fetch('/convert_pdf_to_jpg', {
    ...
    .then(converted => {
      ...
      link.href = url;
      link.download = 'converted_images.zip'; // Name of the downloaded file
      document.body.appendChild(link);
      link.click();
      link.remove();
      window.location.href = '/pdf_jpg'; // Redirect to the ppt page
    })
    .catch(error => {
