...
// Connects to data-controller="ppt-to-pdf"
  ...
  sendrequest() {
    ...
    fetch('/convert_ppt_to_pdf', {
      ...
      .then(converted => {
        ...
        link.href = url;
        link.download = 'converted_ppt.pdf'; // Name of the downloaded file
        document.body.appendChild(link);
        link.click();
        link.remove();
        window.location.href = '/ppt_pdf'; // Redirect to the jpg page
      })
      .catch(error => {
